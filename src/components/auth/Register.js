...
import { getSpecificEmail, postCustomer } from "../ApiManager"
import "./Login.css"
...
export const Register = (props) => {
    ...
    const existingUserCheck = () => {
        return getSpecificEmail(customer)
    ...
    return (
        <main style={{ textAlign: "center" }}>
            ...
            <form className="form--login" onSubmit={handleRegister}>
                <h1 className="h3 mb-3 font-weight-normal">Please Register for Kandy Korner's Kandy Kidz</h1>
                <fieldset>
